...
public class MarkersResource {
    ...
    @PostMapping("/markers")
    @Timed
    public ResponseEntity<Marker> createMarkers(@RequestBody Marker markers) throws URISyntaxException {
        ...
        Marker result = markersRepository.save(markers);
    ...
    @PutMapping("/markers")
    @Timed
    public ResponseEntity<Marker> updateMarkers(@RequestBody Marker markers) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<Marker> getMarkers(@PathVariable Long id) {
        log.debug("REST request to get Markers : {}", id);
        Optional<Marker> markers = markersRepository.findById(id);
    ...
    @Timed
    public List<Marker> searchMarkers(@RequestParam String query) {
