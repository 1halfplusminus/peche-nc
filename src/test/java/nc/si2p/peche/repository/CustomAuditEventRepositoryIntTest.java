...
import nc.si2p.peche.config.audit.AuditEventConverter;
import nc.si2p.peche.domain.PersistentAuditEvent;
...
import static nc.si2p.peche.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
