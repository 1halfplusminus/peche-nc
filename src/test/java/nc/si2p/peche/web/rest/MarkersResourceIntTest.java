...
public class MarkersResourceIntTest {
    ...
    public void createMarkers() throws Exception {
        ...
        List<Marker> markersList = markersRepository.findAll();
        assertThat(markersList).hasSize(databaseSizeBeforeCreate + 1);
        Marker testMarkers = markersList.get(markersList.size() - 1);
    ...
    public void updateMarkers() throws Exception {
        ...
        // Update the markers
        Marker updatedMarkers = markersRepository.findById(markers.getId()).get();
    ...
    public void equalsVerifier() throws Exception {
        ...
        Marker markers1 = new Marker();
        markers1.setId(1L);
        Marker markers2 = new Marker();
