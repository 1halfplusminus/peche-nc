...
import nc.si2p.peche.config.Constants;
import nc.si2p.peche.domain.Authority;
import nc.si2p.peche.domain.User;
import nc.si2p.peche.repository.AuthorityRepository;
import nc.si2p.peche.repository.UserRepository;
import nc.si2p.peche.security.AuthoritiesConstants;
import nc.si2p.peche.service.MailService;
import nc.si2p.peche.service.UserService;
import nc.si2p.peche.service.dto.PasswordChangeDTO;
import nc.si2p.peche.service.dto.UserDTO;
import nc.si2p.peche.web.rest.errors.ExceptionTranslator;
import nc.si2p.peche.web.rest.vm.KeyAndPasswordVM;
import nc.si2p.peche.web.rest.vm.ManagedUserVM;
