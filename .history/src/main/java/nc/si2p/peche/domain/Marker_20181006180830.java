...
public class Marker implements Serializable {
    ...
    public Marker iconContentType(String iconContentType) {
    ...
    public Marker titre(String titre) {
        this.titre = titre;
        return this;
    }
    ...
    public Marker email(String email) {
        this.email = email;
        return this;
    }
    ...
    public Marker pjContentType(String pjContentType) {
    ...
    public Marker date(LocalDate date) {
        this.date = date;
        return this;
    }
